...
import com.codepath.example.instagramclone.MainActivity;
...
public class ComposeFragment extends Fragment {
    ...
    private Button btnPost, btnTakePhoto;
        ...
        post.saveInBackground(new SaveCallback(){
            ...
            public void done(ParseException e) {
                if(e != null){
                    ...
                    Toast.makeText(getContext(), "Issue getting posts", Toast.LENGTH_SHORT).show();
                    return;
                }
